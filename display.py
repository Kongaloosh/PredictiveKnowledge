...
class Display(object):
    def __init__(self, foreground):
        ...
        self.voronoiCanvas = Canvas(self.root, borderwidth=0, highlightthickness=0, width=WIDTH, height=HEIGHT,
                                    bg="black")
        ...
        self.taPlot.legend()
        self.taCanvas = FigureCanvasTkAgg(self.tAFigure,
                                          master=self.root)  # canvas.get_tk_widget().grid(row=1,column=4,columnspan=3,rowspan=20)
